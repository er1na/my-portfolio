    ...
    return (
        ...
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            <a href="#projects" className="px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900">Projects</a>
            <a href="#skills" className="px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900">Skills</a>
            <a href="#about" className="px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900">About</a>
            <a href="#contact" className="px-3 py-2 text-sm text-zinc-600 hover:text-zinc-900">Contact</a>
          </div>
          <div className="flex items-center gap-2">
