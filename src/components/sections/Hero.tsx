      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 text-zinc-600">犬好きエンジニアです。</p>
            <div className="mt-5 flex flex-wrap items-center gap-3">
              ...
              <a
                href="https://github.com/er1na"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-zinc-600 hover:text-zinc-900 pr-2"
              >
                <Github className="w-4 h-4" /> GitHub
              </a>
              <a
                href="https://x.com/riiin_rin24"
                target="_blank"
                rel="noopener noreferrer"
