...
export default function ProjectCard({ title, description, languages, link }: { title: string, description: string | null, languages: string | null | undefined, link: string }) {
    return (
        <Card className="rounded-3xl border-zinc-100 hover:shadow-md transition-shadow">
                <CardHeader>
                  <CardTitle className="flex items-center justify-between text-zinc-800">
                    {title}
                    <a href={link} className="text-zinc-400 hover:text-zinc-700">
                ...
                <CardContent>
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Badge variant="secondary" className="rounded-xl bg-white text-zinc-700 border">
                        {languages}
                    </Badge>
                  </div>
                </CardContent>
